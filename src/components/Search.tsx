      ...
      {(query().length >= 2 && results().length >= 1) && (
        <div class="mt-12">
          <div class="text-sm uppercase mb-2">
            {results().length} {results().length == 1 ? "résultat" : "résultats" } pour {`'${query()}'`}
          </div>
